...
public interface DiagnosisService extends IService<Diagnosis> {
     ...
     * @Param: request 诊断问卷提交请求参数 userId 当前操作用户ID
     * @Return: DiagnosisReportVO 诊断报告数据
     * @Description: 提交诊断问卷，计算总分、等级和建议，保存诊断记录
    **/
    DiagnosisReportVO submitDiagnosis(DiagnosisSubmitRequest request, Long userId);
    ...
    **/
    DiagnosisReportVO getDiagnosisById(Long id, Long userId);
    ...
    **/
    DiagnosisReportVO getLatestDiagnosis(Long manuId, Long userId);
