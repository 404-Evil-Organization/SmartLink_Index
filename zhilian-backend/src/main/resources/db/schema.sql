...
(
    ...
    `product_type`     TEXT COMMENT '主营产品类型（如PCB、半导体、消费电子）',
    `description`      TEXT COMMENT '企业简介',
    `logo`             TEXT COMMENT 'Logo图片URL',
...
(
    ...
    `contact_person`   VARCHAR(50) COMMENT '联系人',
    `contact_phone`    VARCHAR(20) COMMENT '联系人电话',
    `service_type`     TEXT COMMENT '服务大类（如检测认证、工业设计、物流等），可多选，用逗号分隔或JSON',
